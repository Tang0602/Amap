...
def verify_walk_to_nearest_food(device_id=None):
    """
    验证步行导航到最近美食店任务是否完成
    ...
    try:
        ...
        cmd.extend([
            ...
            "cat",
            "files/16_walk_to_nearest_food.json"  # JSON 文件路径
        ])
...
if __name__ == "__main__":
    print("=" * 60)
    print("指令 16 验证：步行导航去周边最近的美食店")
    print("=" * 60)

    # 执行验证
    success = verify_walk_to_nearest_food()
